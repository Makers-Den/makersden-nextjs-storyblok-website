...
// import MakerHand from '../../../public/images/maker-peace.png';
...
/**
 * Default OG image, if the page is not an article and there is no title of the page that is what is going to be used.
 */
