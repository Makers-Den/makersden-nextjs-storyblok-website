        ...
        <div className='grid'>
          ...
          {blok.image && (
            <AnimateOnScroll
              delay={0}
              duration={1.2}
              className='relative col-start-1 row-start-1 h-full min-h-[500px] w-full md:min-h-[600px] lg:min-h-[700px]'
            >
              <StoryblokImage
          ...
          {/* Overlaid Content */}
          <div className='relative z-10 col-start-1 row-start-1 flex flex-col justify-end pt-10'>
